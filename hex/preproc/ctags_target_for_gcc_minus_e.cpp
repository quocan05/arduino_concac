# 1 "F:\\KMA\\Arduino\\ditmecuocdoigpt\\ditmecuocdoigpt.ino"
# 2 "F:\\KMA\\Arduino\\ditmecuocdoigpt\\ditmecuocdoigpt.ino" 2
...
# 9 "F:\\KMA\\Arduino\\ditmecuocdoigpt\\ditmecuocdoigpt.ino" 2
Servo myServo;
...
void setup() {
  ...
  pinMode(MOTOR_LEFT_1, 0x1);
  pinMode(MOTOR_LEFT_2, 0x1);
  pinMode(MOTOR_RIGHT_1, 0x1);
  pinMode(MOTOR_RIGHT_2, 0x1);
...
void KC()
{
  digitalWrite(trig, 0x0); // tat chan trig
  delayMicroseconds(2);
  digitalWrite(trig, 0x1); // phat xung tu chan trig
